define(['beerexpertcollection', 'beerexpertitemview', 'beerexpertlistview'], function(collection, itemview, listview) {
	var initialize = function () {
		...
		beerExpertCollection = new collection( data );
		beerExpertListview = new listview({ collection: beerExpertCollection });
		beerExpertListview.render();
	};
	return initialize;
});
